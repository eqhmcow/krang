...
C<Krang.Ajax.update()> javascript function can now take a function
as the value of C<target> to be executed on-demand after the actual
request is done. [Michael Peters]
