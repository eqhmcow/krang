...
directory, as follows:
    ...
    mkdir -p $HOME/PERL_MOD_BUILD/perl_parts
...
environment variables to make the next few tasks a bit easier:
    ...
    export PERL_PARTS=$HOME/PERL_MOD_BUILD/perl_parts
    export PERL5LIB=$PERL_PARTS/lib/site_perl/5.6.1:$KRANG_ROOT/lib:$PERL5LIB


To further simplify your task, set up the following aliases:

    alias perlprep='perl Makefile.PL PREFIX=$PERL_PARTS INSTALLMAN3DIR=$PERL_PARTS/man/man3'
...
your task a bit easier:
    ...
    export NEW_MODULES_LIB=$PERL_PARTS/lib/site_perl/5.6.1
