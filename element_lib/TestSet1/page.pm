   ...
   my %args = ( name => 'page',
                ...
                [ 
                 pkg('ElementClass::Text')->new(name         => "header",
                                                ...
                                                allow_delete => 0,
                                                reorderable  => 0),
                 pkg('ElementClass::CheckBox')->new(name => "wide_page",
                                                    min  => 1,
                                                    max  => 0,
                                                    allow_delete => 0,
                                                    reorderable => 0),
                 pkg('ElementClass::PopupMenu')->new(name => "bg_color",
                                                  display_name => "Background Color",
                                                  values => ['', qw(white blue
                                                                red grey)],
                                                 ),
                 pkg('ElementClass::ListBox')->new(name => "ad_links",
                 ...
                 pkg('ElementClass::XinhaEditor')->new(name => "paragraph",
                                                     required => 1,
                                                     bulk_edit => 0,
                                                    ),
                 pkg('ElementClass::XinhaEditor')->new(name => "std_paragraph",
                                                       toolbar_config => 'standard',
                                                     required => 1,
                                                     bulk_edit => 0,
                                                    ),
                 pkg('ElementClass::XinhaEditor')->new(name => "fancy_paragraph",
                                                       toolbar_config => 'all',
                                                     required => 1,
                                                     bulk_edit => 0,
                                                    ),
                 pkg('ElementClass::Textarea')->new(name => "pull_quote",
                                                    required => 1,
                                                    rows     => 2,
                                                   ),
                 ...
                 pkg('ElementClass::StoryLink')->new(name => "leadin_covers",
                                                     find => { class => 'cover' } ),

                 pkg('ElementClass::MediaLink')->new(name => "photo_image_only",
