...
Calendar.prototype.create = function (_par) {
    ...
    // we want a slightly different title bar in Krang
    // Instead of 2 levels with "about" link and "today" link
    // we just want one level with month/year buttons and the
    ...
    */
	...
	this.title = hh("", this.weekNumbers ? 4 : 3, 300);
	this.title.className = "title";
	if (this.isPopup) {
		this.title.ttip = Calendar._TT["DRAG_TO_MOVE"];
		this.title.style.cursor = "move";
