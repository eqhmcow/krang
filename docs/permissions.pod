...
the specified $user is assigned and return a hash of net permissions.
...
levels.  This method is expected to be called wherever security
decisions regarding desks must be made.
...
This method will combine admin permissions for a particular user and
