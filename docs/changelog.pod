...
Fixed bug where it was possible to 'View' the version of a Story or Media 
object currently being edited prior to the View Schedule screen, which caused 
'Edit' button to be present - instead, user can click 'Back'. [Noam Weinstein]
