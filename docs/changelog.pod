...
Implemented 'Undo' button that returns Story to the state and location it was in prior to 
being edited, and redirects the user to the page from where he/she opened it. [Noam Weinstein]
