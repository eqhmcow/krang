...
=head2 3.02 - IN DEVELOPMENT

=over

=item *

Added localization admin scripts C<lang/bin/krang_lang_installer> and
C<lang/bin/krang_lang_uninstaller> and updated install and upgrade
documentation. [Bodo Schulze]
