...
Fixed bug in krang_upload_templates that sets NO_ELEMENTLIBS to 1 even though it's
necessary to instantiate the Category element when creating new categories. [Noam Weinstein]
