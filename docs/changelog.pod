...
to the checked status of the list's row checkboxes. [Bodo Schulze]

=item *

Added infrastructure to enable/disable list buttons on Find screens
according to checked status of row checkboxes.  Also implemented it
for Find Story and Active Stories, and for the choosers' OK
button. [Bodo Schulze]
