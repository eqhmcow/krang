...
Implemented 'Cancel' button on Story Edit screen that returns Story to the desk and owner to whom
it previously belonged, and sends user to the page from where he/she opened it. [Noam Weinstein]
