...
Implemented 'Cancel' button in Story and Template Edit that returns object to its previous location
(i.e. owner, desk, etc.) and sends user to the page from where he/she opened it. [Noam Weinstein]
