...
my $list = pkg('List')->new(    list_group_id => $lg->list_group_id,
                                name => 'test_list_1',
                            );
...
my $list2 = pkg('List')->new(   list_group_id => $lg->list_group_id,
                                name => 'test_list_2',
...
my $li_1 = pkg('ListItem')->new(    list => $list,
                                    data => 'Test top data' );
...
my $li_2 = pkg('ListItem')->new(  list => $list2,
                                  parent_list_item => $li_1,
                                  data => '2nd level data here' );
$li_2->save();
END { $li_2->delete };

my $li_3 = pkg('ListItem')->new(  list => $list2,
                                  parent_list_item => $li_1,
...
my $li_4 = pkg('ListItem')->new(  list => $list2,
                                  parent_list_item => $li_1,
