...
Added test_categorylink() to t/publish.t (implicitely tests
...
removing warning in view() of Krang::CGI::Story occuring when story
...
In F<krang.conf>, allow multiple word InstanceDisplayName.
[Bodo Schulze]
