...
=head2 v1.018 - Under Development

=over

=item *

Fixed bug where unknown errors during story publish would trigger an
exit without any kind of useful message.  The error is now printed to
STDERR. [Peter]
