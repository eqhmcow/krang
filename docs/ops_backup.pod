...
If you're restoring onto a different machine then you'll need to edit
C</path/to/krang/conf/krang.conf> after installation is complete to
correct the C<HostName> and IP address settings.
