...
my $story = pkg('Story')->new(class => "article", title => "t", slug => "s", categories => [$category]);
$story->save;
...
is ($media_in_db->element->child('page')->child('header')->data => "Test This Header", "media element has correct value in database");
