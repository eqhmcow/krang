...
Redhat Linux 7.3 on x86

=item *

Redhat Linux 9 on x86

=back

Krang supports these versions of Perl, one of which must be available
before installing Krang:
...
course, this will require porting work if Krang doesn't support your
platform.  

=head1 Installation

Once you've downloaded Krang, un-tar it and enter the directory:
...
Password assigned to the "admin" Krang user (e.g., "shredder").  This
