   ...
   my %args = ( name => 'category',
                children => [
                    ...
                    Krang::ElementClass::Text->new(name => 'display_name',
                                                            ...
                                                            reorderable => 0,
                                                            required => 1),
                    Krang::ElementClass::MediaLink->new(name => "primary_css",
                                                     max => 1,
                                                     ),
                    Krang::ElementClass::MediaLink->new(name => "secondary_css",
                                                     max => 1,
                                                     ),
...
sub fill_template {
    ...
    # see about link_to_top_of_page
     $tmpl->param( link_to_top_of_page =>  $story->element->child('link_to_top_of_page')->data ) if $story->element->child('link_to_top_of_page');
