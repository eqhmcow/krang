...
Added script F<bin/krang_storable_freezethaw> to help migrating
between 32bit and 64bit architectures. [Bodo Schulze]
...
Fixed FTP download of templates with UTF8 characters in binary mode.  [Brad Oaks]

=item *

Editing and saving an existing category will now convert a story with a duplicate
url into a category index. This check already happens when creating a new category.
[Brad Oaks]

=item *

The Find Story button for a Lead In element of a story now works in the Chrome browser.
[Brad Oaks]
