...
=head2 v1.017 - Under Development

=over

=item *

Fixed Krang::CGI::Publisher to leave error messages thrown during the
publish process up on the screen, rather than quickly redirecting the
user back to their previous page. [Peter]
