...
F<templates.kds>.  This file must be a valid HREF[Krang
Dataset|xml.html] file containing only L<Krang::Template> objects.  If
present, it will be loaded into the database by C<krang_createdb>.
...
list group.  For example:
  ...
  <list_groups>
    <list_group list_group_name="Make/Model/Year">
      <list list_name="Make" />
      <list list_name="Model" />
      <list list_name="Year" />
    </list_group>

    <list_group list_group_name="Segments">
      <list list_name="Segments" />
     </list_group>
  </list_groups>

This configuration file describes a three-level tree of
make/model/year values as well as a flat list of segments.  See
L<Krang::ListGroup>, L<Krang::List>, and L<Krang::ListItem> for
further details.
