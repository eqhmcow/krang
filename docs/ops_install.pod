...
The following instructions will install Krang on a RedHat Linux 7.3 or
Redhat Linux 9 system, on the i686 architecture.
...
You can specify multiple addons to install.
