...
=item Template UI - variable browser (future)
...
The current Krang website was put together in about 15 minutes,
perhaps less.  It needs a redesign.  Getting rid of the IFrames would
be a nice start.
